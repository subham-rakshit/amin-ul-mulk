      ...
      >
        ...
        >
          <TransitionLink
            ...
            className={`${leftSidebarSizeType === sidebarSize.SMALL_HOVER_VIEW ? "hidden" : `${globalStyleObj.flexCenter}`} size-full pt-1`}
          >
            {leftSidebarSizeType === sidebarSize.SMALL_ICON_VIEW ? (
              <div className="relative w-full h-full overflow-hidden">
                <Image
                  src="/amin-ul-miulk-law-firm/website-logo/rounded-logo.svg"
                  alt="logo small"
                  fill
          ...
          >
            <TransitionLink
              href={ROUTES.ADMIN_DASHBOARD_ECOMMERCE}
              className={`${globalStyleObj.flexStart} transition-300 h-full w-full pt-1 pr-1`}
            >
              {leftSidebarSizeMain === sidebarMainSize.SM_HOVER &&
              !isContainerHover ? (
