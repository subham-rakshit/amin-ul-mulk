...
const RightSidebar = ({ isScrollTop }) => {
  ...
  switch (layoutThemePrimaryColorType) {
    ...
    case layoutThemePrimaryColor.DEFAULT:
      borderColor = "border border-[#2b5591]";
      colorHex = "#2b5591";
      bgColor = rightSidebarPrimaryColorData[0].bgColor;
      bgGradientColor = "bg-gradient-to-r from-[#2b5591] to-[#525252]";
      bgGradientFourthChildColor =
        "bg-gradient-to-r from-[#1d2129] to-[#2b5591]";
      break;
                    ...
                    {leftSidebarImageType === imgBtn.id ? (
                      <>
                        <FaCheckCircle
                          size={16}
                          color="#fff"
                          className="z-[99] rounded-full border border-[#2b5591]"
                        />
                        <div
