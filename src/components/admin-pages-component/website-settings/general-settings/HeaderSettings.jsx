...
import { NormalSwitchInputField, SettingsUpdateButton } from "@/components";
...
const HeaderSettings = ({ userId }) => {
  ...
  // Handle Socials Switch State
  const onChangeSocialsSwtichState = () => {
    setFormData((prev) => ({
      ...prev,
      show_socials_switcher: prev.show_socials_switcher === "0" ? "1" : "0",
    }));
  };
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleHeaderSettingsDataSubmit} className="py-4 px-5">
        ...
        {/* Show Socials Switcher */}
        {/* <NormalSwitchInputField
          isFetching={isFetching}
          labelText="Show Socials Switcher?"
          fieldId="show-socials-switcher"
          fieldName="show_socials_switcher"
          switchStatus={formData?.show_socials_switcher || "0"}
          onChangeSwtichState={onChangeSocialsSwtichState}
        ...
        {/* <NormalTextInputField
          ...
          fieldId="helpline-email"
          fieldName="helpline_email"
          placeholderText="Helpline Email"
          inputValue={formData?.helpline_email || ""}
          onChangeTextInputField={onChangeTextInputField}
          extraContainerClasses="mt-5"
        /> */}
