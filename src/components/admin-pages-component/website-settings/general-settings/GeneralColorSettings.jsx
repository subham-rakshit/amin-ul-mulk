  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleGeneralSettingsSubmit} className="py-4 px-5">
        ...
        <NormalTextInputField
          isFetching={isFetching}
          labelText="Text Dark Color"
          fieldId="text-dark-color"
          fieldName="text_dark_color"
          placeholderText="Text Dark Color"
          inputValue={formData?.text_dark_color || ""}
          onChangeTextInputField={onChangeTextInputField}
          extraFiledInfo="Hex Color Code Seperated by comma. Example: #f00,#f0f"
          extraContainerClasses="mt-5"
        />
        ...
        <NormalTextInputField
          isFetching={isFetching}
          labelText="Text Light Color"
          fieldId="text-light-color"
          fieldName="text_light_color"
          placeholderText="Text Light Color"
          inputValue={formData?.text_light_color || ""}
          onChangeTextInputField={onChangeTextInputField}
          extraFiledInfo="Hex Color Code Seperated by comma. Example: #f00,#f0f"
          extraContainerClasses="mt-5"
        />
