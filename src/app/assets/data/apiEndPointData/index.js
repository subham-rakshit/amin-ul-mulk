const API_ENDPOINTS = {
  ...
  // Service::
  CREATE_NEW_SERVICE: "/api/service/create",
  EDIT_SERVICE: "/api/service/update",
  GET_ALL_SERVICES: "/api/service/view",
  GET_SERVICE_DETAILS: "/api/service/details",
  DELETE_SERVICE: "/api/service/delete",
  TOGGLE_ACTIVE_SERVICE_STATUS: "/api/service/toggle-active-status",
  TOGGLE_FEATURED_SERVICE_STATUS: "/api/service/toggle-featured-status",
  // <> PUBLIC <>
  GET_ALL_PUBLIC_SERVICES: "/api/client/service/view",
  GET_PUBLIC_SERVICE_DETAILS: "/api/client/service/details",

  // Case Package::
  CREATE_NEW_CASE_PACKAGE: "/api/case-package/create",
  EDIT_CASE_PACKAGE: "/api/case-package/update",
  GET_ALL_CASE_PACKAGES: "/api/case-package/view",
  GET_CASE_PACKAGE_DETAILS: "/api/case-package/details",
  DELETE_CASE_PACKAGE: "/api/case-package/delete",
  TOGGLE_ACTIVE_CASE_PACKAGE_STATUS: "/api/case-package/toggle-active-status",
  TOGGLE_FEATURED_CASE_PACKAGE_STATUS:
    "/api/case-package/toggle-featured-status",
  // <> PUBLIC <>
  GET_ALL_PUBLIC_CASE_PACKAGES: "/api/client/case-package/view",
